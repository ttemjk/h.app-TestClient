...
public class HeliosMessagingServiceHelper {
    ...
    private final HeliosReceiver mHeliosReceiver;
    private HeliosMessageListener mActivityReceiver;
    private final Hashtable<String, HeliosMessageListener> mSubscribers = new Hashtable<>();
    ...
    private class HeliosReceiver implements HeliosMessageListener, MessagingService.MessagingServiceStatusListener {
        ...
        public void showMessage(HeliosTopic heliosTopic, HeliosMessage heliosMessage) {
            ...
            if (null == heliosTopic) {
                ...
                while (a.hasMoreElements()) {
                    mSubscribers.get(a.nextElement()).showMessage(null, heliosMessage);
                }
        ...
        // Connect and subscribe to topicstl
    ...
    private void doHeliosConnect() {
        ...
        if (mBound) {
            try {
                ...
                if (!mService.isConnected()) { // No connection available!!
                    Log.e(TAG, "HeliosService not connected.");
                    return;
                ...
                /*
                String defaultTopic = mService.getString(R.string.chat_default_topic);
                HeliosTopic topic = new HeliosTopic(defaultTopic, defaultTopic);
            ...
            */
                ...
                String defaultBugChannel = mService.getString(R.string.chat_bug_channel);
                boolean showBugChannel = mService.getString(R.string.chat_show_bug_channel).equals("true");
                if(showBugChannel) {
                    HeliosTopic bugTopic = new HeliosTopic(defaultBugChannel, defaultBugChannel);
    ...
    public void unsubscribe(HeliosTopic heliosTopic) throws HeliosMessagingException {
        ...
        if (mBound) {
            if (mSubscribers.containsKey(heliosTopic.getTopicName())) {
                ...
                Log.d(TAG, "Unsubscribed " + heliosTopic.getTopicName());
            } else {
